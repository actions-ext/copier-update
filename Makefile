...
lint-py:  ## lint python with ruff
	python -m ruff check copier_update
	python -m ruff format --check copier_update
...
fix-py:  ## autoformat python code with ruff
	python -m ruff check --fix copier_update
	python -m ruff format copier_update
...
test:  ## run python tests
	python -m pytest -v copier_update/tests

coverage:  ## run tests and collect test coverage
	python -m pytest -v copier_update/tests --cov=copier_update --cov-report term-missing --cov-report xml
